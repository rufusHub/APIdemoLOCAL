...
public class TC5_Post_Elie {
	
	public static String returnIdValue;
	
	@Test(groups = {"group3","post"})
	public void testCase1() throws IOException {
		
		//Report.
		ExtentReports report = ReportHandling.handleReport();
		ExtentTest tc1 = report.startTest("TC5_Post_Elie");
		
		//Values.
		Properties p = PropertiesHandle.loadProperties("..//API_demo_local/URI.properties");
		String requestBody = JsonHandle.readJsonData("..//API_demo_local/src/test/java/org/demo/resources/requestBody_array_3.json"); 
		String urikeyname = "OSE_URI";
		...
		//Validation.
		Object result = validateResponse.statusCodeVAlidate(201, resobj, "TC5_Post_Elie" );
		
		if(result.equals(true)) {
			tc1.log(LogStatus.PASS, "Test Case 5, is getting pass.");
			report.endTest(tc1);
			report.flush();
		}
		else {
			tc1.log(LogStatus.FAIL, "Test Case 5, is getting fail.");
			report.endTest(tc1);
			report.flush();
		}
