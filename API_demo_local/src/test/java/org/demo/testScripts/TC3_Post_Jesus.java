...
public class TC3_Post_Jesus {
	
	public static String returnIdValue;
	
	@Test(groups = {"group2","post"})
	public void testCase1() throws IOException {
		
		//Report.
		ExtentReports report = ReportHandling.handleReport();
		ExtentTest tc1 = report.startTest("TC3_Post_Jesus");
		
		//Values.
		Properties p = PropertiesHandle.loadProperties("..//API_demo_local/URI.properties");
		String requestBody = JsonHandle.readJsonData("..//API_demo_local/src/test/java/org/demo/resources/requestBody_array_2.json"); 
		String urikeyname = "OEN_URI";
		...
		//Validation.
		Object result = validateResponse.statusCodeVAlidate(201, resobj, "TC3_Post_Jesus" );
		
		if(result.equals(true)) {
			tc1.log(LogStatus.PASS, "Test Case 3, is getting pass.");
			report.endTest(tc1);
			report.flush();
		}
		else {
			tc1.log(LogStatus.FAIL, "Test Case 3, is getting fail.");
			report.endTest(tc1);
			report.flush();
		}
